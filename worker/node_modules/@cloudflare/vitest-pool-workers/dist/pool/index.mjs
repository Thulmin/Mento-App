...
//#endregion
//#region ../workers-utils/dist/chunk-ELQRF72O.mjs
	...
	return bindings.filter((binding) => binding.type !== "secret_text").reduce((configObj, binding) => {
		switch (binding.type) {
			...
			case "ai_search":
				...
				break;
			case "websearch":
				configObj.websearch = { binding: binding.name };
				break;
			case "agent_memory":
...
var require_comparator = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/semver@7.7.1/node_modules/semver/classes/comparator.js": ((exports, module) => {
...
var require_satisfies = /* @__PURE__ */ __commonJS({ "../../node_modules/.pnpm/semver@7.7.1/node_modules/semver/functions/satisfies.js": ((exports, module) => {
...
async function listDurableObjectIds(request, mf, url) {
	...
	if (bindingName === null) return new Response(null, { status: 400 });
	const workerName = url.searchParams.get("worker_name") ?? void 0;
...
const workerdBuiltinModules = new Set([...[
	...
	"node-internal:internal_inspector",
...
async function resolve(vite, method, target, specifier, referrer) {
	...
	if (isRequire && target.endsWith(wasmModuleSuffix)) target = trimSuffix("?module", target);
...
function ensureRootedPath(filePath) {
...
async function load(vite, logBase, method, target, specifier, filePath) {
	if (method === "require" && target.endsWith(wasmModuleSuffix) && filePath.endsWith(".wasm")) {
...
async function parseCustomPoolOptions(rootPath, value) {
	...
	if (options.wrangler?.configPath !== void 0) {
		...
		const { workerOptions, externalWorkers, define, main } = wrangler.unstable_getMiniflareWorkerOptions(wranglerConfig, options.wrangler.environment, {
			overrides: {
